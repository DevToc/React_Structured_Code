...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      from: {
        path: '^(src)',
        pathNot: ['\\.(spec|test|stories)\\.(js|mjs|cjs|ts|tsx|ls|coffee|litcoffee|coffee\\.md)$', 'setupTests\\.ts'],
      },
      to: {
...
// generated: dependency-cruiser@11.7.1 on 2022-05-18T13:12:58.117Z
