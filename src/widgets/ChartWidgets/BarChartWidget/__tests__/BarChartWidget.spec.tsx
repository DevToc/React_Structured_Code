...
import { generateDefaultData } from '../BarChartWidget.helpers';
import { ReadOnlyBarChartWidget } from '../BarChartWidget';
...
describe('widgets/BarChartWidget.tsx', () => {
  it('should render the widget', () => {
    renderWidget(<ReadOnlyBarChartWidget />, { widget: { ...mockWidget, widgetId: mockId } });
  ...
  it('axis titles should be bold by default', () => {
    const { container } = renderWidget(<ReadOnlyBarChartWidget />, { widget: { ...mockWidget, widgetId: mockId } });
  ...
  it('should update x and y axis line colour', () => {
    ...
    const { container } = renderWidget(<ReadOnlyBarChartWidget />, { widget });
