...
import { generateDefaultData } from '../StackedBarChartWidget.helpers';
import { ReadOnlyStackedBarChartWidget } from '../StackedBarChartWidget';
...
describe('widgets/StackedBarChartWidget.tsx', () => {
  it('should render the widget', () => {
    const widget = { ...mockWidget, widgetId: mockId };
    renderWidget(<ReadOnlyStackedBarChartWidget widgetData={mockWidget.widgetData} widgetId={mockId} />, { widget });

    const stackedBarChartWidget = screen.queryByTestId(/widgetbase-/);
    expect(stackedBarChartWidget).toBeInTheDocument();
  });
  ...
  it('axis titles should be bold by default', () => {
    const { container } = renderWidget(<ReadOnlyStackedBarChartWidget />, {
