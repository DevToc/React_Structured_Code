...
const ChartSwapperMobile = () => {
  ...
  const handleSelect = (e: React.SyntheticEvent<HTMLButtonElement>): void => {
    ...
    replaceWidget(mergeChartData(e.currentTarget.dataset.value as unknown as ChartType, currentWidgetData));
  };
...
export default ChartSwapperMobile;
