...
import { DEFAULT_HEIGHT, DEFAULT_WIDTH } from './StackedColumnChartWidget.config';
import { chartColorPalette } from '../ChartWidget.config';
import { ChartDataSeries } from '../ChartWidget.types';
import { VERSION } from './StackedColumnChartWidget.upgrade';
import { StackedColumnChartWidgetData } from 'widgets/ChartWidgets/StackedColumn/StackedColumnChartWidget.types';
...
export const generateDefaultData = () => {
  return {
    ...
    } as StackedColumnChartWidgetData,
  };
};
