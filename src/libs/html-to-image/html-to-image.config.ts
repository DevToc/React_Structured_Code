export interface Options {
  ...
  /**
   * A preset css style to be prepended to svg foreignobject before converting to data url
   * It uses to reset unwanted css style like selection highlight and hover overlay.
   */
  presetCssStyle?: HTMLStyleElement;
  /**
  ...
  /**
   * A function will remove textContent from giving node and its children nodes.
   */
  filterText?: (domNode: HTMLElement) => boolean;
  /**
