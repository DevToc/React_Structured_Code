...
import { isDataUrl, resolveUrl, makeDataUrl, getMimeType } from './html-to-image.helpers';
...
export function embed(
  ...
  return Promise.resolve(resolvedURL)
    .then<string | { blob: string; contentType: string }>((url) => (get ? get(url) : getBlobFromURL(url, options)))
    .then((data) => {
