/**
 * Custom version from https://github.com/ZeeCoder/use-resize-observer
 */
import { useEffect, useState, useRef, useMemo, RefObject, RefCallback, useCallback } from 'react';
